...
from carla_car_env import CarEnv
...
parser.add_argument("--epsilon-decay", type=float, default=0.99995, help="]0, 1] every step epsilon = epsilon * decay, in order to decrease constantly")
...
parser.add_argument("--max-distance-norm", type=float, default=0, help="divide lidar elems by [max-distance-norm] to normalize between [0, 1]")
parser.add_argument("--lidar-reduction-method", choices=['avg', 'max', 'min', 'sampling'], default='', type=str.lower, help="method used to aggregate lidar data")
...
parser.add_argument("--max-step-limit", type=int, default=1000, help="maximum steps that can be done in one episode")
